    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <footer className="bg-gray-900 dark:bg-black text-white py-10 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8 mb-8">
          <div>
            <h4 className="font-bold text-white mb-3">Udaan Information Services LLP</h4>
            <p className="text-gray-400 text-sm leading-relaxed">Offshore accounting talent and technology-driven finance solutions for global businesses since 2016.</p>
          </div>
          <div>
            <h4 className="font-bold text-white mb-3">Quick Links</h4>
            <ul className="space-y-2 text-sm text-gray-400">
              {["Services", "About Us", "Testimonials", "Book Appointment", "Contact"].map((l) => (
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>📧 info@udaanllp.com</li>
              <li>🌍 Serving UK, USA, Australia & India</li>
            </ul>
          </div>
        </div>
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full flex items-center justify-center shadow-lg transition hover:scale-110"
